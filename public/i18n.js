...
const I18N = {
  de: {
    ...
    // ── Auto-Bewerbung (Plattform-Jobs) ──
    'ap.title': 'Auto-Bewerbung', 'ap.easy': 'Einfach bewerben',
    'ap.easyTitle': 'Einfach bewerben / Easy Apply verfügbar',
    'ap.externalOnly': 'Bewerbung nur extern auf der Unternehmensseite möglich.',
    'ap.prepare': 'Bewerbung vorbereiten',
    'ap.prepareHelp': 'Anschreiben und Formular werden vorbereitet — gesendet wird erst nach deiner Freigabe.',
    'ap.queuedToast': 'Bewerbung in der Warteschlange',
    'ap.questions': 'Fragen aus dem Bewerbungsformular',
    'ap.fromLibraryTitle': 'Aus früheren Antworten vorbefüllt',
    'ap.coverLetter': 'Anschreiben', 'ap.approve': 'Bewerben',
    'ap.approveConfirm': 'Bewerbung freigeben? Sie wird danach automatisch versendet und kann nicht zurückgeholt werden.',
    'ap.approvedToast': 'Freigegeben — wird versendet', 'ap.savedToast': 'Gespeichert',
    'ap.retry': 'Erneut versuchen', 'ap.discard': 'Verwerfen',
    'ap.discardConfirm': 'Bewerbung wirklich verwerfen?',
    'ap.state.queued': 'In Warteschlange', 'ap.state.preparing': 'Wird vorbereitet…',
    'ap.state.awaiting_answers': 'Fragen offen', 'ap.state.ready_for_review': 'Bereit zur Freigabe',
    'ap.state.approved': 'Freigegeben', 'ap.state.submitting': 'Wird gesendet…',
    'ap.state.submitted': 'Gesendet', 'ap.state.failed': 'Fehlgeschlagen', 'ap.state.discarded': 'Verworfen',

    // ── Plattform-Zugänge ──
    'creds.title': 'Plattform-Zugänge (Auto-Bewerbung)',
    'creds.help': 'Zugangsdaten für LinkedIn, StepStone und Indeed – verschlüsselt gespeichert und nur für das automatische Bewerben genutzt. Hinweis: automatisiertes Bewerben verstößt gegen die Nutzungsbedingungen der Plattformen und kann zur Kontosperrung führen.',
    'creds.noKey': 'CREDENTIALS_KEY ist nicht gesetzt. In den Einstellungen (Auto-Bewerbung) hinterlegen — erzeugen mit: npm run generate-credentials-key',
    'creds.passSet': 'gesetzt — leer lassen zum Behalten', 'creds.passUnset': 'Passwort',
    'creds.state.ok': 'Session aktiv', 'creds.state.challenge': 'Manuelle Bestätigung nötig',
    'creds.state.invalid': 'Login fehlgeschlagen', 'creds.state.unknown': 'Noch kein Login',
    'creds.delete': 'Zugangsdaten löschen', 'creds.delConfirm': 'Zugangsdaten und gespeicherte Session wirklich löschen?',
    'creds.deleted': 'Zugangsdaten gelöscht', 'creds.saved': 'Gespeichert',
    'creds.needEmail': 'E-Mail ist erforderlich',
    'creds.test': 'Login testen', 'creds.testing': 'Login wird getestet… (kann 10–30 s dauern)',
    'creds.testOk': 'Login erfolgreich ✓ — Session gespeichert.',
    'creds.testFail': 'Login fehlgeschlagen: ',
    'creds.cv': 'Lebenslauf (PDF)', 'creds.cvSet': 'hochgeladen', 'creds.cvUnset': 'noch keiner hochgeladen',
    'creds.cvUpload': 'PDF hochladen', 'creds.cvUploaded': 'Lebenslauf hochgeladen',
    'creds.autoApply': 'Auto-Bewerbung für diesen Klienten',
    'creds.autoApplyHelp': 'Neue relevante Jobs mit „Einfach bewerben" automatisch zur Freigabe vorbereiten (global zusätzlich per AUTO_APPLY_ENABLED geschaltet).',
    ...
    'stats.legendFound': 'Gefunden', 'stats.legendRelevant': 'Relevant', 'stats.logScale': 'log. Skala',
    'stats.inLastYear': ' im letzten Jahr', 'stats.lastRun': 'letzter Lauf · ', 'stats.total': 'Gesamt',
    'stats.combinedRuns': 'kombiniert', 'stats.runsWord': 'Läufe',
    ...
    'sources.title': 'Quellen', 'sources.addSource': '+ Quelle', 'sources.namePh': 'Name',
    'sources.urlPh': 'https://…', 'sources.delTitle': 'Entfernen',
    'sources.needNameUrl': 'Jede Karriereseite braucht Name und URL.',
    'sources.needName': 'Jede Quelle braucht einen Namen.',
    'sources.needKeywords': 'Quelle „{name}": Job-Börsen brauchen ein Stichwort.',
    'sources.type.careers-page': 'Karriereseite', 'sources.type.linkedin': 'LinkedIn',
    'sources.type.stepstone': 'StepStone', 'sources.type.indeed': 'Indeed',
    'sources.kwPh': 'Stichwort (z. B. Entwicklungsingenieur)', 'sources.locPh': 'Ort (z. B. Stuttgart)',
    'sources.radiusPh': 'km',
    ...
    // Profile form: group headings, field labels, hints
    'profile.group.cv': 'Lebenslauf (CV)',
    'profile.group.preferences': 'Präferenzen',
    'profile.field.name': 'Name',
    'profile.field.currentRole': 'Aktuelle Rolle / Status',
    'profile.field.yearsOfExperience': 'Berufserfahrung (Jahre)',
    'profile.field.summary': 'Kurzprofil',
    'profile.field.summary.h': '2–3 Sätze: Fachgebiet, Stärken, was du suchst. Geht direkt an die KI.',
    'profile.field.skills.domain': 'Fachliche Kompetenzen',
    'profile.field.skills.domain.h': 'Eine pro Zeile',
    'profile.field.skills.tools': 'Tools / Software',
    'profile.field.skills.programming': 'Programmierung',
    'profile.field.languages': 'Sprachen',
    'profile.field.education': 'Ausbildung',
    'profile.field.education.h': 'Ein Abschluss pro Zeile',
    'profile.field.experience': 'Berufserfahrung (Stationen)',
    'profile.field.experience.h': 'Eine Station pro Zeile',
    'profile.field.desiredRoles': 'Wunsch-Rollen',
    'profile.field.desiredRoles.h': 'Job-Titel, die du suchst',
    'profile.field.locations': 'Orte',
    'profile.field.locations.h': 'Städte, "Remote", "Hybrid" …',
    'profile.field.industries': 'Branchen',
    'profile.field.salaryMin': 'Mindestgehalt (€/Jahr)',
    'profile.field.contractTypes': 'Vertragsarten',
    'profile.field.dealbreakers': 'No-Gos',
    'profile.field.dealbreakers.h': 'Was du auf keinen Fall willst',
  ...
  en: {
    ...
    // ── Auto-apply (platform jobs) ──
    'ap.title': 'Auto-apply', 'ap.easy': 'Easy apply',
    'ap.easyTitle': 'Easy apply available',
    'ap.externalOnly': 'Application only possible externally on the company site.',
    'ap.prepare': 'Prepare application',
    'ap.prepareHelp': 'Cover letter and form are prepared — nothing is sent until you approve.',
    'ap.queuedToast': 'Application queued',
    'ap.questions': 'Questions from the application form',
    'ap.fromLibraryTitle': 'Pre-filled from previous answers',
    'ap.coverLetter': 'Cover letter', 'ap.approve': 'Apply',
    'ap.approveConfirm': 'Approve this application? It will be submitted automatically and cannot be recalled.',
    'ap.approvedToast': 'Approved — will be submitted', 'ap.savedToast': 'Saved',
    'ap.retry': 'Retry', 'ap.discard': 'Discard',
    'ap.discardConfirm': 'Really discard this application?',
    'ap.state.queued': 'Queued', 'ap.state.preparing': 'Preparing…',
    'ap.state.awaiting_answers': 'Questions open', 'ap.state.ready_for_review': 'Ready for review',
    'ap.state.approved': 'Approved', 'ap.state.submitting': 'Submitting…',
    'ap.state.submitted': 'Submitted', 'ap.state.failed': 'Failed', 'ap.state.discarded': 'Discarded',

    // ── Platform accounts ──
    'creds.title': 'Platform accounts (auto-apply)',
    'creds.help': 'Credentials for LinkedIn, StepStone and Indeed — stored encrypted, used only for auto-applying. Note: automated applying violates the platforms\' terms of service and can get accounts suspended.',
    'creds.noKey': 'CREDENTIALS_KEY is not set. Add it in Settings (Auto-apply) — generate with: npm run generate-credentials-key',
    'creds.passSet': 'set — leave empty to keep', 'creds.passUnset': 'Password',
    'creds.state.ok': 'Session active', 'creds.state.challenge': 'Manual confirmation needed',
    'creds.state.invalid': 'Login failed', 'creds.state.unknown': 'No login yet',
    'creds.delete': 'Delete credentials', 'creds.delConfirm': 'Really delete credentials and the saved session?',
    'creds.deleted': 'Credentials deleted', 'creds.saved': 'Saved',
    'creds.needEmail': 'Email is required',
    'creds.test': 'Test login', 'creds.testing': 'Testing login… (may take 10–30 s)',
    'creds.testOk': 'Login successful ✓ — session saved.',
    'creds.testFail': 'Login failed: ',
    'creds.cv': 'CV (PDF)', 'creds.cvSet': 'uploaded', 'creds.cvUnset': 'none uploaded yet',
    'creds.cvUpload': 'Upload PDF', 'creds.cvUploaded': 'CV uploaded',
    'creds.autoApply': 'Auto-apply for this client',
    'creds.autoApplyHelp': 'Automatically prepare new relevant easy-apply jobs for approval (also gated globally by AUTO_APPLY_ENABLED).',
    ...
    'stats.legendFound': 'Found', 'stats.legendRelevant': 'Relevant', 'stats.logScale': 'log scale',
    'stats.inLastYear': ' in the last year', 'stats.lastRun': 'last run · ', 'stats.total': 'Total',
    'stats.combinedRuns': 'combined', 'stats.runsWord': 'runs',
    ...
    'sources.title': 'Sources', 'sources.addSource': '+ Source', 'sources.namePh': 'Name',
    'sources.urlPh': 'https://…', 'sources.delTitle': 'Remove',
    'sources.needNameUrl': 'Each career page needs a name and a URL.',
    'sources.needName': 'Each source needs a name.',
    'sources.needKeywords': 'Source "{name}": job boards need a keyword.',
    'sources.type.careers-page': 'Career page', 'sources.type.linkedin': 'LinkedIn',
    'sources.type.stepstone': 'StepStone', 'sources.type.indeed': 'Indeed',
    'sources.kwPh': 'Keyword (e.g. Development Engineer)', 'sources.locPh': 'Location (e.g. Stuttgart)',
    'sources.radiusPh': 'km',
    ...
    // Profile form: group headings, field labels, hints
    'profile.group.cv': 'Résumé (CV)',
    'profile.group.preferences': 'Preferences',
    'profile.field.name': 'Name',
    'profile.field.currentRole': 'Current role / status',
    'profile.field.yearsOfExperience': 'Years of experience',
    'profile.field.summary': 'Short profile',
    'profile.field.summary.h': '2–3 sentences: your field, strengths, what you want. Sent straight to the AI.',
    'profile.field.skills.domain': 'Domain skills',
    'profile.field.skills.domain.h': 'One per line',
    'profile.field.skills.tools': 'Tools / software',
    'profile.field.skills.programming': 'Programming',
    'profile.field.languages': 'Languages',
    'profile.field.education': 'Education',
    'profile.field.education.h': 'One degree per line',
    'profile.field.experience': 'Work experience (roles)',
    'profile.field.experience.h': 'One role per line',
    'profile.field.desiredRoles': 'Desired roles',
    'profile.field.desiredRoles.h': 'Job titles you are targeting',
    'profile.field.locations': 'Locations',
    'profile.field.locations.h': 'Cities, "Remote", "Hybrid" …',
    'profile.field.industries': 'Industries',
    'profile.field.salaryMin': 'Minimum salary (€/year)',
    'profile.field.contractTypes': 'Contract types',
    'profile.field.dealbreakers': 'Dealbreakers',
    'profile.field.dealbreakers.h': 'Things you definitely do not want',
